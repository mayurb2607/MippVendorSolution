...
//    public virtual DbSet<WorkorderWorkDescription> WorkorderVendorWorkDescriptions { get; set; }

//    public virtual DbSet<WorkorderTask> WorkorderWorkDescriptions { get; set; }

//    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
//        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=MippTest;Trusted_Connection=True; User Id=ANAR\\Pratik.p;Password=Sarita-123; MultipleActiveResultSets=true;TrustServerCertificate=True;");
...
//        //{
//        //    entity.HasKey(e => e.Id).HasName("PK__Bill__3214EC073D2B67EA");
...
//        //{
//        //    entity.HasKey(e => e.Id).HasName("PK__BillItem__3214EC07007A9F4E");
...
//        //{
//        //    entity.HasKey(e => e.Id).HasName("PK__Tax__3214EC07D2075081");
...
//        {
//            entity.HasKey(e => e.Id).HasName("PK__Workorde__3214EC07700AAAC6");
...
//        {
//            entity.ToTable("WorkorderVendorWorkDescription");

//            entity.Property(e => e.AdditionalComment).HasColumnType("text");
//            entity.Property(e => e.DescriptionOfWork).HasMaxLength(50);
...
//        //    entity.Property(e => e.DescriptionOfWorkToComplete).HasColumnName("DescriptionOfWorkToComplete");
